...
class LikeController {
  ...
  void toggleLike({required WidgetRef ref, required String postId}) {
    ...
    /// Optimistic Update
    feedController.updatePosts(updatedPosts);
    ...
    _debounceTimers[postId] = Timer(
      ...
      () async {
        try {
          ...
          final revertedPosts = [...feedController.state.posts];

          revertedPosts[postIndex] = originalPost;

          feedController.updatePosts(revertedPosts);
        }
      },
    );
  }
